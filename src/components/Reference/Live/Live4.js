...
import LiveLogo from "assets/images/refer-live-logo4.webp";
import LiveImage1 from "assets/images/live4-1.webp";
import LiveImage2 from "assets/images/live4-2.webp";
    ...
    <>
      <div className="lg:hidden">
        ...
        <div className="font-light text-left pt-10 p-8">
          ...
          <div className="mb-8 leading-8">
            아이허브는 사전에 큐시트로 내부 심의팀을 통해 검토를 진행하였습니다.
            이를 기반으로 라이브 진행 채널 및 고객사와 확인 후 출연자들과 긴밀한
            소통을 하였습니다. ​
          </div>
