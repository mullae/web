  ...
  return (
    <>
      ...
      <div className="hidden lg:block mt-24">
        ...
        <div className="flex justify-center py-20 px-40">
          <table className="logo-table">
            <tbody>
              <tr>
                {logo1.map((item, index) => (
                  <td key={index} className="p-10">
                    <a href={item.link} target="_blank" rel="noreferrer">
